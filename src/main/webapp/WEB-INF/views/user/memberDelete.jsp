						...
						<div class="col-lg-7">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								<div class="card-header">
									<h3 class="text-center font-weight-light my-4">회원탈퇴</h3>
								</div>
								<div class="card-body">
									<form name="form" id="delete_form" role="form" method="post">
										<div class="form-row">
											<div class="col-md-6">
										...
										<div class="form-group">
											...
											<input class="form-control py-4" id="inputEmailAddress"
												...
												readonly="readonly" placeholder="Enter email address"
												value="${member.email }" />
										</div>
										<div class="form-row">
											<div class="col-md-6">
									...
									<div class="form-group mt-4 mb-0">
										<button type="button" class="btn btn-primary btn-block"
											id="btnSignup" onclick="registerCheck()" disabled="disabled">회원탈퇴</button>
										<button type="button" class="btn btn-primary btn-block"
